...
const getAllCreditos = async (req, res) => {
    try {
        ...
        const creditosRefinanciados = ff.define(
            "vw_creditos_refinanciados",
            {
            ...
            },
            {
                ff,
                timestamps: false,
                modelName: "vw_creditos_refinanciados",
            }
        );

        const data = await creditosRefinanciados.findAll({
            raw: true,
        });
