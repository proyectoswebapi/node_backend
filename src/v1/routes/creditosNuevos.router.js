...
const creditosNuevosController = require('../../controllers/creditosNuevos.controller.js');
...
router.get('/creditosnuevos', verificarToken, creditosNuevosController.getAllCreditos);
