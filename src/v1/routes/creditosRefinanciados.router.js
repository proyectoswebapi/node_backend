...
const creditosRefinanciadosController = require('../../controllers/creditosRefinanciados.controller.js');
...
router.get('/creditosrefinanciados', verificarToken, creditosRefinanciadosController.getAllCreditos);
