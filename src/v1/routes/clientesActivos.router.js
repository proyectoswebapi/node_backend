...
const clientesActivosController = require('../../controllers/clientesActivos.controller.js');
...
router.get('/clientesactivos', verificarToken, clientesActivosController.getAllClientes);
